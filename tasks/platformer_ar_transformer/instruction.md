# Platformer -- Ar Transformer World Model

## Mission

Treat the ar transformer as a **starting-point world model** for Platformer.
...
`experiments/platformer_ar_transformer/<run_id>/`
