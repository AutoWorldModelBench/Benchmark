# Snake -- Dreamer World Model

## Mission

Treat the dreamer as a **starting-point world model** for Snake.
...
- Game: snake (48 max entities per frame)
- Active gameplay fields: none
- Shared cache: `/data/snake/_cache/`
...
`experiments/snake_dreamer/<run_id>/`
