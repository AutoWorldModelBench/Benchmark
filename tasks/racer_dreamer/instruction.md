# Racer -- Dreamer World Model

## Mission

Treat the dreamer as a **starting-point world model** for Racer.
...
- Game: racer (6 max entities per frame)
- Active gameplay fields: none
- Shared cache: `/data/racer/_cache/`
...
`experiments/racer_dreamer/<run_id>/`
