# Breakout -- Dreamer World Model

## Mission

Treat the dreamer as a **starting-point world model** for Breakout.
...
- Game: breakout (52 max entities per frame)
- Active gameplay fields: none
- Shared cache: `/data/breakout/_cache/`
...
`experiments/breakout_dreamer/<run_id>/`
