# Frogger -- Dreamer World Model

## Mission

Treat the dreamer as a **starting-point world model** for Frogger.
...
- Game: frogger (28 max entities per frame)
- Active gameplay fields: none
- Shared cache: `/data/frogger/_cache/`
...
`experiments/frogger_dreamer/<run_id>/`
