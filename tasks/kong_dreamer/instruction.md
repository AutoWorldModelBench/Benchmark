# Kong -- Dreamer World Model

## Mission

Treat the dreamer as a **starting-point world model** for Kong.
...
- Game: kong (16 max entities per frame)
- Active gameplay fields: none
- Shared cache: `/data/kong/_cache/`
...
`experiments/kong_dreamer/<run_id>/`
