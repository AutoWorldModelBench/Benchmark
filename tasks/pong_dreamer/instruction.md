# Pong -- Dreamer World Model

## Mission

Treat the dreamer as a **starting-point world model** for Pong.
...
- Game: pong (5 max entities per frame)
- Active gameplay fields: none
- Shared cache: `/data/pong/_cache/`
...
`experiments/pong_dreamer/<run_id>/`
